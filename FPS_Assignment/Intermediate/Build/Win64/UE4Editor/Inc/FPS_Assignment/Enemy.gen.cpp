...
#include "FPS_Assignment/Enemy.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	FPS_ASSIGNMENT_API UClass* Z_Construct_UClass_AEnemy_NoRegister();
	FPS_ASSIGNMENT_API UClass* Z_Construct_UClass_AEnemy();
...
// End Cross Module References
	...
	DEFINE_FUNCTION(AEnemy::execOnHit)
	{
		...
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->OnHit(Z_Param_HitComponent,Z_Param_OtherActor,Z_Param_OtherComponent,Z_Param_OtherBodyIndex,Z_Param_bFromSweep,Z_Param_Out_Hit);
		P_NATIVE_END;
	}
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AEnemy_OnHit_Statics::NewProp_OtherComponent_MetaData[] = {
		{ "EditInline", "true" },
	};
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_AEnemy_OnHit_Statics::NewProp_OtherComponent = { "OtherComponent", nullptr, (EPropertyFlags)0x0010000000080080, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Enemy_eventOnHit_Parms, OtherComponent), Z_Construct_UClass_UPrimitiveComponent_NoRegister, METADATA_PARAMS(Z_Construct_UFunction_AEnemy_OnHit_Statics::NewProp_OtherComponent_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_AEnemy_OnHit_Statics::NewProp_OtherComponent_MetaData)) };
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_AEnemy_OnHit_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AEnemy_OnHit_Statics::NewProp_OtherComponent,
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AEnemy_OnHit_Statics::Function_MetaDataParams[] = {
		{ "Comment", "//This is for the enemy to get hit by the projectiles\n" },
		{ "ModuleRelativePath", "Enemy.h" },
		{ "ToolTip", "This is for the enemy to get hit by the projectiles" },
	};
#endif
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_SpottedPlayer_MetaData[];
#endif
		static const UE4CodeGen_Private::FObjectPropertyParams NewProp_SpottedPlayer;
#if WITH_METADATA
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_AEnemy_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_AEnemy_OnHit, "OnHit" }, // 70187088
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AEnemy_Statics::NewProp_DamageCollision_MetaData[] = {
		{ "Category", "Enemy" },
		{ "Comment", "//To assign a Box collision to the enemy \n" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Enemy.h" },
		{ "ToolTip", "To assign a Box collision to the enemy" },
	};
#endif
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AEnemy_Statics::NewProp_AIPerComp_MetaData[] = {
		{ "Category", "Enemy" },
		{ "Comment", "//These are for the enemy to sense the player sop we can get its location for the enemy to move towards\n" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Enemy.h" },
		{ "ToolTip", "These are for the enemy to sense the player sop we can get its location for the enemy to move towards" },
	};
#endif
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AEnemy_Statics::NewProp_SpottedPlayer_MetaData[] = {
		{ "ModuleRelativePath", "Enemy.h" },
	};
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AEnemy_Statics::NewProp_SpottedPlayer = { "SpottedPlayer", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AEnemy, SpottedPlayer), Z_Construct_UClass_APawn_NoRegister, METADATA_PARAMS(Z_Construct_UClass_AEnemy_Statics::NewProp_SpottedPlayer_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AEnemy_Statics::NewProp_SpottedPlayer_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AEnemy_Statics::NewProp_Health_MetaData[] = {
		{ "Category", "Enemy" },
		{ "Comment", "//Total health of the enemy\n" },
		{ "ModuleRelativePath", "Enemy.h" },
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AEnemy_Statics::NewProp_DamageValue_MetaData[] = {
		{ "Category", "Enemy" },
		{ "Comment", "//Amount value to deal to the player\n" },
		{ "ModuleRelativePath", "Enemy.h" },
		{ "ToolTip", "Amount value to deal to the player" },
	};
#endif
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AEnemy_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AEnemy_Statics::NewProp_SpottedPlayer,
	...
	IMPLEMENT_CLASS(AEnemy, 901978619);
	template<> FPS_ASSIGNMENT_API UClass* StaticClass<AEnemy>()
	{
		return AEnemy::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_AEnemy(Z_Construct_UClass_AEnemy, &AEnemy::StaticClass, TEXT("/Script/FPS_Assignment"), TEXT("AEnemy"), false, nullptr, nullptr, nullptr);
