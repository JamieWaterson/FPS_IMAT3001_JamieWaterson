...
#include "FPS_Assignment/HealthPickup.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	FPS_ASSIGNMENT_API UClass* Z_Construct_UClass_AHealthPickup_NoRegister();
	FPS_ASSIGNMENT_API UClass* Z_Construct_UClass_AHealthPickup();
...
// End Cross Module References
...
#endif
		static const UE4CodeGen_Private::FUnsizedIntPropertyParams NewProp_healthAmount;
...
#endif
	const UE4CodeGen_Private::FUnsizedIntPropertyParams Z_Construct_UClass_AHealthPickup_Statics::NewProp_healthAmount = { "healthAmount", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AHealthPickup, healthAmount), METADATA_PARAMS(Z_Construct_UClass_AHealthPickup_Statics::NewProp_healthAmount_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AHealthPickup_Statics::NewProp_healthAmount_MetaData)) };
	...
	IMPLEMENT_CLASS(AHealthPickup, 194363757);
	template<> FPS_ASSIGNMENT_API UClass* StaticClass<AHealthPickup>()
	{
		return AHealthPickup::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_AHealthPickup(Z_Construct_UClass_AHealthPickup, &AHealthPickup::StaticClass, TEXT("/Script/FPS_Assignment"), TEXT("AHealthPickup"), false, nullptr, nullptr, nullptr);
